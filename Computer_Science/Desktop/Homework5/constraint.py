...
__all__ = ["Problem", "Variable", "Domain", "Unassigned",
           ...
           "NotInSetConstraint", "SomeInSetConstraint", "MustEqConstraint",
           "SomeNotInSetConstraint"]
...
class MustEqConstraint(FunctionConstraint):
    def __funcFact__(self,variable,value):
        def Judge(guess):
            return guess==value
        return Judge
    def __init__(self, variable, value): 
        ...
        @param value: the value that the variable must be
        """
        f = self.__funcFact__(variable,value)
        FunctionConstraint.__init__(self,f)
