...
// get a handle to the database
    ...
    // the query that will add this review to the database  
    $query = 'UPDATE reviewer, articles, people SET decision="' . $decision . '", comments="' . $addcomments .
    '", ebcomments="' . $ebcomments . '" WHERE articles.article_id=reviewer.article_id AND reviewer.people_id=people.people_id;';
