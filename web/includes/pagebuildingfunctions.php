...
function makeNavBarStr()
{
	...
	else if($loggedIn)
	{
		...
		//Used to edit profile for future implimentation
		//$retStr .= '
...
function makeSideBarStr()
{
	...
	if($_SESSION['page_name']=='author' && $loggedIn)
	{
		$retStr .= "
			<ul>
				...
				<li><a href=" . $AUTHOR_URL . "new_associations.php>Confirm Authorship</a></li>
				<li><a href=" . $AUTHOR_URL . "view_articles.php>View Articles</a></li>
				<li><a href=" . $AUTHOR_URL . "my_reviews.php>My Reviews</a></li>
				<!-- For future implementation <li><a href=" . $AUTHOR_URL . "resubmit.php>Resubmit Article</a></li> -->
			</ul>
	";
	}
	...
	elseif($_SESSION['page_name']=='reviewer' && $loggedIn)
	{
		$retStr .= "
			<ul>
				<li><a href=" . $REVIEWER_URL . "acceptdecline.php>Accept or Decline articles</a></li>
				<li><a href=" . $REVIEWER_URL . "assigned_articles.php>My Assigned Articles</a></li>
				<li><a href=" . $REVIEWER_URL . "index.php>Submit a Review</a></li>
			</ul>
	";
	}
	elseif($_SESSION['page_name']=='ebm' && $loggedIn)
	{
		$retStr .= "
			<ul>
				<li><a href=" . $EBM_URL . "index.php>Assign an Article</a></li>
				<li><a href=" . $EBM_URL . "emailmembers.php>Email Authors or Reviewers</a></li>
				<li><a href=" . $EBM_URL . "article_decision.php>Accept or Reject Articles</a></li>
			</ul>
	";
	}
