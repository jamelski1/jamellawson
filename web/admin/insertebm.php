...
$_SESSION['page_name']='admin';
    ...
    // check if it worked
    if ($result) {
        echo "Person with the id number " . $person . " was given editorial board member priveledges.";
        echo "<p>";
        echo "<a href='user_permissions.php'>Go to your dashboard</a><br>";
    } else {
        echo "Something went horribly wrong when giving ebm priviledges to person with the id number " . $person . ".";
