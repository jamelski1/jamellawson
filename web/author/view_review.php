...
if(!isset($_POST['submit']))	// we need to present the form and get the data
  {
    ...
    $query = "SELECT DISTINCT articles.title, articles.theTime, articles.status, articles.rating, articles.ebmcomments, articles.article_id, people.firstname, people.lastname, ebm_detail.people_id
	FROM articles, ebm_detail, people
	WHERE articles.article_id = $article_id
	AND articles.article_id = ebm_detail.article_id
	AND people.people_id = ebm_detail.people_id
