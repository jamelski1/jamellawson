...
<head>
    <title>Confirm Article feedback</title>
</head>

<body>

<h1>
    Confirm Article	feedback
</h1>
...
include_once($INCLUDES_DIR . 'functions.php');
	...
	$query = "insert into article_detail 
    ...
    // check if it worked
    if ($result) {
        echo "Author was connected to the article.";
        echo "<p>";
		echo "<a href='index.php'>Return to Dashboard</a><br>";
    } else {
        echo "Something went horribly wrong connected the article to the author.";
