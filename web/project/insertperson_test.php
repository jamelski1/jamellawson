...
<?php
	...
	//get expertise id query NUMBER 1
	...
	if ($expertise_id) {
		...
		$the_actual_expertise1 = $row['expertise_id'];
    
        
    } else {
        echo "Something went wrong when retrieving expertise id from the database.<p>";
        echo "This was the error: " . $db->error . "<p>";
    }
	
	//This adds the connects a person to an expertise NUMBER 1
	$connect_expertise_detail = "INSERT INTO expertise_detail(
	people_id,
	expertise_id)
	
	VALUES('" . $the_actual_id . "', '" . $the_actual_expertise1 . "');";
	
	// execute sql statement NUMBER1
	...
	if($connect_expertise_detail){
        ...
        echo "Something went wrong when inserting expertise detail into the database.<p>";
        echo "This was the error: " . $db->error . "<p>";
		
	}
	
	//get expertise id query NUMBER 2
	$get_expertise_id_query = "SELECT expertise_id
	FROM expertise
	WHERE expertise.expertise_name = '" . $expertise2 . "';";
	...
	if ($expertise_id) {
        $numberofrows = $expertise_id->num_rows;
        $row = $expertise_id->fetch_assoc();
		$the_actual_expertise2 = $row['expertise_id'];
	...
	//This adds the connects a person to an expertise NUMBER 2
	$connect_expertise_detail = "INSERT INTO expertise_detail(
	people_id,
	expertise_id)
	
	VALUES('" . $the_actual_id . "', '" . $the_actual_expertise2 . "');";
