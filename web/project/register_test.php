...
<?php
	//This Creates the Expertise 2 Drop Down
    // get a handle to the database
    @ $db = new mysqli('dbdev.cs.uiowa.edu', 'jllawsn', 'MwomvmeTs67R', 'db_jllawsn');
    ...
    if ($result) {
		...
		echo '<tr>';
		echo '<td>Field of Expertise 2:</td>';
        echo '<td><select name="expertise2">';
		echo '<option value="" selected>Please Select ...</option>';
...
<?php
	//This Creates the Expertise 3 Drop Down
    // get a handle to the database
    @ $db = new mysqli('dbdev.cs.uiowa.edu', 'jllawsn', 'MwomvmeTs67R', 'db_jllawsn');
    ...
    if ($result) {
		...
		echo '<tr>';
		echo '<td>Field of Expertise 3:</td>';
        echo '<td><select name="expertise3">';
		echo '<option value="" selected>Please Select ...</option>';
