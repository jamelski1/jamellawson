...
<div class="wrapper tablet">
        ...
        <div class="main-content contact-tablet">
            ...
            <form class="contact-form" action="spoofjamel.php" method="POST">
            <input class="contact-entry" type="text" name="sender" placeholder="From">
            <br/>
            <input class="contact-entry" type="email" name="email" placeholder="To">
            <br/>
            <input class="contact-entry" type="text" name="subject" placeholder="Subject">
            <br/>
            <textarea name="message" placeholder="Your Message"></textarea>
